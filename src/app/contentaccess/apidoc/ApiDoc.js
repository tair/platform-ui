      ...
      .state('apidoc.subscriptions', {
        ...
        views: {
          apidoc: {
            ...
            templateUrl:
              'contentaccess/apidoc/subscriptions/subscriptions.html',
          },
        },
      })
      .state('apidoc.meters', {
      ...
      .state('apidoc.authorizations', {
        ...
        views: {
          apidoc: {
            ...
            templateUrl:
              'contentaccess/apidoc/authorizations/authorizations.html',
          },
        },
      })
      .state('apidoc.sessionlogs', {
        abstract: true,
        url: '/sessionlogs',
        views: {
          apidoc: {
