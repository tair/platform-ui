						...
						calls : [
									...
									errors : [
											{
												...
												explanation : 'The URI did not contain any parameters to limit the update',
												resolution : 'Supply a valid partyId parameter in the URI request.'
											}, ],
									...
									errors : [
											{
												...
												explanation : 'The URI did not contain any parameters to limit the delete',
												resolution : 'Supply a valid partyId parameter in the URI request.'
											}, ],
									example : 'https://pwapi.arabidopsis.org/parties/?partyId=73',
								},
									...
									errors : [
											{
												...
												explanation : 'The request did not include a query parameter partyId to specify the institution.',
												resolution : 'Supply a valid partyId query parameter in the request.'
											},
											{
												code : '200',
												message : '{"error":"partyId {id} not found in Party tbl"}',
												explanation : 'The specified party id does not identify a known party.',
												resolution : 'Correct the party id value in the request.'
											},
											{
												code : '200',
												message : '"error":"partyId {id} not found in Credential tbl"',
												explanation : 'There is no credential for the specified party id.',
												resolution : 'Correct the party id value in the request.'
											}, ],
									...
									errors : [
											{
												...
												explanation : 'The request entity did not contain a partyType parameter.',
												resolution : 'Supply a valid, form-encoded partyType parameter and value in the request entity.'
											},
											{
												code : '400',
												message : '{"error": "POST method. patyType must be organization"}',
												explanation : 'The partyType parameter had a value other than "organization"',
												resolution : 'Correct the party type to "organization".'
											},
											{
												code : '400',
												message : '{"error":"This email is already used by another institution."}',
												explanation : 'The value for the email parameter in the entity has already been used for another institution.',
												resolution : 'Correct the email value.'
											},
											{
												code : '400',
												message : '{"error": "POST parties/institutions/ password must not be empty"}',
												explanation : 'There was a password paramater in the entity but it had no value.',
												resolution : 'Supply a form-encoded value for the password parameter or remove the parameter.'
											}, ],
									...
									errors : [
											{
												...
												explanation : 'The request did not contain a partyType query parameter.',
												resolution : 'Supply a valid partyId parameter and value in the request URI.'
											},
											{
												code : '400',
												message : '{"error":"This email is already used by another institution."}',
											...
											{
												code : '400',
												message : '{"error": "PUT parties/institutions/ password must not be empty"}',
												explanation : 'There was a password parameter in the entity but it had no value.',
												resolution : 'Supply a form-encoded value for the password parameter or remove the parameter.'
											}, ],
									example : 'https://pwapi.arabidopsis.org/parties/institutions/&partyId=12345',
								},
									...
									errors : [
											{
												code : '400',
												message : '{"error":"does not allow update without query parameters"}',
												explanation : 'The request did not contain any query parameters.',
												resolution : 'Supply a valid partyId parameter and value in the request URI.'
											},
											{
												code : '400',
												message : '{"error":"partyId (aka institutionId) required"}',
												explanation : 'The request had parameters but not the required partyId parameter',
												resolution : 'Supply a valid partyId parameter and value in the request URI.'
											},
											{
												code : '400',
												message : '{"error":"delete partyId {id} failed. partyId not found"}',
												explanation : 'The partyId value did not correspond to a known party id in the database.',
								...
								},
								{
									...
									errors : [
											...
											{
												code : '400',
												message : '{"error": "POST parties/consortiums/. patyType must be consortium"}',
												explanation : 'The partyType parameter had a value other than "consortium"',
												resolution : 'Correct the party type to "consortium".'
											},
											{
												code : '400',
												message : '{"error":"This email is already used by another consortium."}',
												explanation : 'The value for the email parameter in the entity has already been used for another institution.',
												resolution : 'Correct the email value.'
											},
											{
												code : '400',
												message : '{"error": "POST parties/consortiums/ password must not be empty"}',
												explanation : 'There was a password paramater in the entity but it had no value.',
												resolution : 'Supply a form-encoded value for the password parameter or remove the parameter.'
											}, ],
								...
								},
								{
									...
									errors : [
											{
												code : '400',
												message : '{"error": "PUT parties/consortiums/ does not allow update without query parameters"}',
												explanation : 'The request did not contain any parameters.',
												resolution : 'Supply a valid partyId parameter and value in the request URI.'
											},
											{
												code : '400',
												message : '{"error": "PUT parties/consortiums/ partyId required"}',
												explanation : 'The request did not contain a partyType query parameter.',
												resolution : 'Supply a valid partyId parameter and value in the request URI.'
											},
											{
												code : '400',
												message : '{"error": "This email is already used by another consortium."}',
												explanation : 'The value for the email parameter in the entity has already been used for another consortium.',
												resolution : 'Correct the email value.'
											},
											{
												code : '400',
												message : '{"error": "PUT parties/consortiums/ password must not be empty"}',
												explanation : 'There was a password parameter in the entity but it had no value.',
												resolution : 'Supply a form-encoded value for the password parameter or remove the parameter.'
											}, ],
									example : 'https://pwapi.arabidopsis.org/parties/consortiums/&partyId=12345',
									...
									errors : [
											{
												...
												explanation : 'The partyType parameter has a value other than consortium or organization.',
												resolution : 'Supply only consortium or organization as the party type parameter value.'
											}, ],
								...
								},
								{
									...
									errors : [
											{
												code : '400',
												message : '{"error":"does not allow creation without parentPartyId or childPartyId"}',
												explanation : 'The request did not contain a parentPartyId or a childPartyId parameter.',
												resolution : 'Supply both the parentPartyId and the childPartyId parameters in the query parameters of the URI.'
											},
											{
												code : '400',
												message : '{"error":"parentParty does not exist"}',
												explanation : 'The id in the parentPartyId parameter does not exist.',
												resolution : 'Correct the parentPartyId in the query parameters of the URI.'
											},
											{
												code : '400',
												message : '{"error":"childParty does not exist"}',
												explanation : 'The id in the childPartyId parameter does not exist.',
												resolution : 'Correct the childPartyId in the query parameters of the URI.'
											},
											{
												code : '500',
												message : '<h1>Server Error (500)</h1>',
												explanation : 'There was a database error on insert.',
												resolution : 'Check to make sure the two ids are not already linked.'
											}, ],
								...
								},
								{
									...
									errors : [
											{
												code : '400',
												message : '{"error":"does not allow deletion without parentPartyId or childPartyId"}',
												explanation : 'The request did not contain a parentPartyId or a childPartyId parameter.',
												resolution : 'Supply both the parentPartyId and the childPartyId parameters in the query parameters of the URI.'
											},
											{
											...
											},
											{
												...
												resolution : 'Check to make sure the two ids are actually linked.'
											}, ],
									example : 'https://pwapi.arabidopsis.org/parties/affiliations/?parentPartyId=31767&childPartyId=30892',
								},
								{
								...
								},
								{
									...
									errors : [],
									example : 'https://pwapi.arabidopsis.org/parties/usage/partyId=30901',
								}, /*{
									header : '',
									summary : '',
									op : 'GET',
