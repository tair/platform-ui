      ...
      return {
        ...
        apis: {
          ...
          parties: {
            ...
            heading: 'Parties',
            description:
              'A party is an entity that plays a role in the Phoenix system.',
            elements: [
          ...
          subscriptions: {
            ...
            description:
              'A subscription associates a party with a partner for a period of time and allows access to Paid resources.',
            elements: [
          ...
          meters: {
            ...
            heading: 'Meters',
            description:
              'A meter limit imposes a usage limit on parties accessing partner resources without subscriptions.',
            elements: [
          ...
          authorizations: {
            ...
            description:
              'Authorizations determine access to resources for users.',
            elements: [
          ...
          sessionlogs: {
            ...
            description:
              'A session log is a log of page views in a session. Page views are single accesses of a partner resource.',
            elements: [
