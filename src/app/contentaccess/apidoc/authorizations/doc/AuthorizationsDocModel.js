						...
						calls : [
									 ...
									 */
								{
									...
									errors : [ {
										...
										resolution : 'Supply a valid, form-encoded pattern field in the request entity.'
									} ],
									example : 'https://pwapi.arabidopsis.org/authorizations/patterns/',
								},
								{
									...
									errors : [
											{
												code : '400',
												message : '{"error":"PUT method:patternId is required as URL parameter"}',
												explanation : 'There was no query parameter on the URI to limit the scope of the update',
												resolution : 'Add a query parameter such as patternId to the request.'
											},
											{
												code : '400',
												message : '{"error":"PUT method:pattern is required as form-data"}',
												explanation : 'There was no pattern field in the request entity',
												resolution : 'Add a valid, form-encoded pattern field to the request.'
											}, ],
								...
								},
								{
									...
									errors : [ {
										code : '400',
										message : '{"error":"DELETE method:patternId is required as URL parameter"}',
										explanation : 'There was no query parameter on the URI to limit the scope of the delete',
										resolution : 'Add a query parameter such as patternId to the request'
									} ],
									example : 'https://pwapi.arabidopsis.org/authorizations/patterns/&patternId=12345',
								},
									 ...
									 */
								{
									...
									errors : [ {
										code : '400',
										message : '{"error": "POST method:name is required as form-data"}',
										explanation : 'The request did not contain a name field.',
										resolution : 'Supply a valid, form-encoded name field in the request entity.'
									} ],
									example : 'https://pwapi.arabidopsis.org/authorizations/accessTypes/',
								},
								{
									...
									errors : [
											{
												code : '400',
												message : '{"error":"PUT method:accessTypeId is required as URL parameter"}',
												explanation : 'There was no query parameter on the URI to limit the scope of the update',
												resolution : 'Add a query parameter such as patternId to the request.'
											},
											{
												...
												resolution : 'Add a valid, form-encoded name field to the request.'
											}, ],
								...
								},
								{
									...
									errors : [ {
										code : '400',
										message : '{"error":"DELETE method:accessTypeId is required as URL parameter"}',
										explanation : 'There was no query parameter on the URI to limit the scope of the delete',
										resolution : 'Add a query parameter such as patternId to the request'
									} ],
									example : 'https://pwapi.arabidopsis.org/authorizations/accessTypes/&accessTypeId=12345',
									...
									errors : [
											{
												...
												message : '{"error":"PUT method:accessTypeId is required as URL parameter"}',
												explanation : 'There was no query parameter on the URI to limit the scope of the update',
												resolution : 'Add an accessTypeId query parameter to the request.'
											},
											{
												code : '400',
												message : '{"error":"PUT method:patternId is required as form-data"}',
												explanation : 'There was no patternId field in the request entity',
												resolution : 'Add a valid, form-encoded patternId field to the request.'
											},
											{
												code : '400',
												message : '{"error":"PUT method:accessTypeId is required as form-data"}',
												explanation : 'There was no accessType field in the request entity',
												resolution : 'Add a valid, form-encoded accessTypeId field to the request.'
											},
											{
												code : '400',
												message : '{"error":"PUT method:partnerId is required as form-data"}',
												explanation : 'There was no partnerId field in the request entity',
												resolution : 'Add a valid, form-encoded partnerId field to the request.'
											}, ],
								...
								},
								{
									...
									errors : [ {
										code : '400',
										message : '{"error":"DELETE method:accessRuleId is required as URL parameter"}',
										explanation : 'There was no accessRuleId query parameter on the URI to limit the scope of the delete',
										resolution : 'Add an accessTypeId query parameter to the request'
									} ],
