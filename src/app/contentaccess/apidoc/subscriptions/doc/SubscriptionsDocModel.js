					...
					return {
								...
								},
								{
									...
									fields : [
											...
											},
											{
												...
												type : 'Number',
												description : 'Unique identifier for the subscription transaction resulting from the operation',
											}, ],
								},
								{
								...
								},
								{
									...
									fields : [
											...
											},
											{
												name : 'requestDate',
												type : 'Date',
												description : 'Date of the subscription request; format mm/dd/yyyy',
											},
											{
												name : 'firstName',
												type : 'String',
						...
						calls : [
									...
									errors : [
											{
												...
												resolution : 'Supply a valid subscriptionId query parameter in the request.'
											}, ],
									...
									errors : [
											{
												code : '400',
												message : '{"error":"Essential parameters needed."}',
												explanation : 'The request did not contain all of the parameters partnerId, ipAddress, and userIdentifier.',
												resolution : 'Supply valid filter query parameters in the request.'
											}, ],
									...
									body_parameters : [
											{
												name : 'partyId',
												type : 'Number',
												description : 'Unique identifier for the subscribing party (required)',
											},
											{
												name : 'partnerId',
												type : 'String',
									...
									errors : [
											{
												...
												explanation : 'The activation code has a party id associated with it, meaning it has already activated a subscription.',
								...
								},
								{
									...
									summary : '',
									op : 'GET',
									uri : '/subscriptions/activationCodeGenerator/?quantity={number}&period={number}&partnerId={string}',
									parameters : [
											{
												name : 'quantity',
												type : 'Number',
												description : 'Number of activation codes to generate (maximum 99)',
											},
											{
												name : 'period',
												type : 'Number',
											...
											},
											{
												name : 'partnerId',
												type : 'String',
												description : 'Unique identifier for the partner to which to subscribe with the codes',
											}, ],
									body_parameters : [],
									returns : 'an Array of String activation codes',
									errors : [],
									example : 'https://pwapi.arabidopsis.org/subscriptions/activationCodeGenerator/?quantity=10&period=30&partnerId=tair',
								},
								{
								...
								},
								{
									...
									errors : [
											{
												code : '400',
												message : '{"partyId":["This field is required."],"partnerId":["This field is required."]}',
												explanation : 'You did not specify a party id or a partnerId in the request body.',
												resolution : 'Supply valid, form-encoded values for partnerId and partyId in the request body.'
											}, ],
									example : 'https://pwapi.arabidopsis.org/subscriptions/1445/renewal/',
								},
								{
									header : 'Get the Payment Page as HTML',
									summary : 'Get the HTML payment page, filling in details as specified in the request.',
									op : 'GET',
									...
									parameters : [
											{
												name : 'termiId',
												type : 'Number',
												description : 'Unique identifier for the subscription term (required)',
											},
											{
												name : 'quantity',
												type : 'Number',
												description : 'Number of activation codes to generate (required)',
											}, ],
									body_parameters : [],
									...
									errors : [
											...
											},
											{
												...
												resolution : 'Correct the quantity to be between 1 and 99, inclusive.'
											}, ],
									example : 'https://pwapi.arabidopsis.org/subscriptions/payments/?termId=20&quantity=5',
								},
								{
									header : 'Submit a Payment to Stripe and Email Activation Codes to Subscriber',
									summary : 'Submit a payment for a set of activation codes to the Stripe merchant processing service, and if payment succeeds, send an email to the user containing the purchased activation codes.',
									op : 'POST',
									...
									body_parameters : [
											{
												name : 'stripeToken',
												type : 'String',
												description : 'a single-use token from Stripe.card.createToken() encapsulating user information that you can safely pass to the API to charge the user (required)',
											},
											{
												name : 'price',
												type : 'Number',
											...
											},
											{
												name : 'quantity',
												type : 'Number',
												description : 'Number of activation codes to purchase (required)',
											},
											{
												name : 'email',
												type : '',
												description : 'The email to which to send activation codes and payment notifications (required)',
											},
											{
												name : 'firstName',
												type : 'String',
											...
											},
											{
												name : 'institute',
												type : 'String',
												description : 'Organization to which the user belongs (required)',
											},
											{
												name : 'street',
												type : 'String',
									...
									errors : [
											{
												...
												explanation : 'The supplied total amount does not match the term price times the quantity ordered times the group discount rate.',
											...
											},
											{
												...
												resolution : 'Correct the problem as directed by the Stripe error message.'
											}, ],
									example : 'https://pwapi.arabidopsis.org/subscriptions/payments/',
								},
								{
									header : 'Send an Email to Phoenix Requesting Institutional Subscription',
									summary : '',
									op : 'POST',
									...
									body_parameters : [
											{
												name : 'partnerName',
												type : 'String',
												description : 'The partner to which the institution wants to subscribe',
											},
											{
												name : 'comments',
												type : 'String',
											...
											},
											{
												name : 'institution',
												type : 'String',
												description : 'The name of the institution requesting subscription',
											},
											{
												name : 'librarianName',
												type : 'String',
									...
									errors : [],
									example : 'https://pwapi.arabidopsis.org/subscriptions/institutions/',
								},
								{
									header : 'Send an Email to Phoenix Requesting Commercial Subscription',
									summary : '',
									op : 'POST',
									...
									body_parameters : [
											{
												name : 'partnerName',
												type : 'String',
												description : 'The partner to which the company wants to subscribe',
											},
											{
												name : 'comments',
												type : 'String',
											...
											},
											{
												...
												type : 'String',
												description : 'Whether the request is for an individual license (true)',
											},
											{
												name : 'companyLicense',
												type : 'String',
												description : 'Whether the request is for an entire company (true)',
											}, ],
									returns : '{"message":"success"}',
									errors : [],
								...
								},
								{
									...
									summary : 'Get the expiration date and subscription status of a requestor based on IP address or login status based on user identifier; if multiple subscriptions apply, date and status of the expiration furthest in the future.',
									op : 'GET',
									uri : '/subscriptions/enddate/?partnerId={id}&ipAddress={string}&userIdentifier={string}',
									parameters : [
											{
												name : 'partnerId',
												type : 'String',
												description : 'Unique id of the partner with the subscription to check',
											},
											{
												name : 'ipAddress',
												type : 'String',
											...
											},
											{
												name : 'userIdentifier',
												type : 'String',
												description : 'The user identifier that identifies a logged-in user to the partner (required but may be empty if not logged in)',
											}, ],
									body_parameters : [],
									returns : 'a SubscriptionStatus object',
									errors : [],
									example : 'https://pwapi.arabidopsis.org/subscriptions/enddate/?partnerId=tair&ipAddress=167.254.2.0&userIdentifier=',
								},
								{
									header : 'Get Active Subscriptions To Partner By IP Address and/or User Identfier',
									summary : 'Get all the active subscriptions to a partner using the request IP address and/or an optional user identifier for an authenticated user.',
									op : 'GET',
									uri : '/subscriptions/active/?partnerId={id}&ipAddress={string}&userIdentifier={string}',
									parameters : [
											{
												name : 'partnerId',
												type : 'String',
											...
											},
											{
												name : 'userIdentifier',
												type : 'String',
												description : 'Unique identifier for the party in the partner system (required but may be empty if party not authenticated)',
											}, ],
									body_parameters : [],
									returns : 'an Array of Subscription objects',
									errors : [
											{
												...
												explanation : 'The request did not include all three required parameters.',
												resolution : 'Supply partnerId, ipAddress, and userIdentifier query parameters in the request.'
											}, ],
									example : 'https://pwapi.arabidopsis.org/subscriptions/active/?partnerId=tair&ipAddress=67.170.218.66&userIdentifier=12345',
								},
								{
									header : 'Get All Active Subscriptions By Party',
									summary : 'Get all the active subscriptions that apply to a specified party.',
									op : 'GET',
									...
									parameters : [
											{
												name : 'id',
												type : 'Number',
												description : 'Unique identifier for the party for which to get active subscriptions',
											}, ],
									body_parameters : [],
									returns : 'a Subscription object as the value of a field named with the partner id: {"tair": {"partyId": 31767, "subscriptionId": 4943, "partnerId": "tair", "endDate": "2017-12-31T12:00:00Z", "startDate": "2015-01-01T12:00:00Z"}}',
									errors : [],
									example : 'https://pwapi.arabidopsis.org/subscriptions/activesubscriptions/31767/',
								},
								{
									header : 'Get All Subscriptions By Party',
									summary : 'Get all the subscriptions that apply to a specified party, whether or not active.',
									op : 'GET',
									...
									parameters : [
											{
												name : 'id',
												type : 'Number',
												description : 'Unique identifier for the party for which to get all subscriptions, whether or not active',
											}, ],
									body_parameters : [],
									returns : 'a Subscription object as the value of a field named with the partner id: {"tair": {"partyId": 31767, "subscriptionId": 4943, "partnerId": "tair", "endDate": "2017-12-31T12:00:00Z", "startDate": "2015-01-01T12:00:00Z"}}',
									errors : [],
									example : 'https://pwapi.arabidopsis.org/subscriptions/allsubscriptions/31767/',
								},
								{
									...
									parameters : [
											{
												name : 'id',
												type : 'Number',
												description : 'Unique identifier for the party with a consortium for which to get active subscriptions (required)',
											}, ],
									body_parameters : [],
									returns : 'an Array of Subscription objects as the value of a field named with the partner id: {"tair": [{"partyId": 31767, "subscriptionId": 4943, "partnerId": "tair", "endDate": "2017-12-31T12:00:00Z", "startDate": "2015-01-01T12:00:00Z"}]}',
									errors : [],
									example : 'https://pwapi.arabidopsis.org/subscriptions/consactsubscriptions/31156/',
								},
								{
									header : 'Send Subscription Request Email to Phoenix',
									summary : 'Send an email to Phoenix with contact information from a user requesting a subcription.',
									op : 'POST',
									...
									body_parameters : [
											{
												name : 'partnerName',
												type : 'String',
												description : 'The name of the partner for which the party is requesting a subscription',
											},
											{
												name : 'partyName',
												type : 'String',
											...
											},
											{
												name : 'partyType',
												type : 'String',
												description : 'The kind of party (user, commercial, institution, consortium)',
											},
											{
												name : 'comments',
												type : 'String',
												description : 'Text with comments about the subscription request',
											}, ],
									returns : '{"message":"success"}',
									errors : [],
								...
								},
								{
									...
									summary : 'Send an email to Phoenix with contact information from a user requesting to renew a subcription.',
									op : 'POST',
									...
									body_parameters : [
											{
												name : 'partnerName',
												type : 'String',
												description : 'The name of the partner for which the party is requesting renewal',
											},
											{
												name : 'partyName',
												type : 'String',
									...
									body_parameters : [
											{
												name : 'requestDate',
												type : 'Date',
												description : 'Date of the subscription request; format mm/dd/yyyy (required)',
											},
											{
												name : 'firstName',
												type : 'String',
									...
									errors : [
											{
												...
												explanation : 'A parameter in the request body was missing or invalid.',
												resolution : 'Supply all required body parameters or correct any invalid ones.'
											}, ],
									example : 'https://pwapi.arabidopsis.org/subscriptions/subscriptionrequest/',
								},
								{
									header : 'Update an Existing Set of Subscription Requests By Filter',
									summary : 'Update a set of subscription requests identified by a set of filter parameters.',
									op : 'PUT',
									uri : '/subscriptions/subscriptionrequest/?subscriptionRequestId={id}&requestDate={date}&firstName={string}&lastName={string}&email={string}&institution={string}&librarianName={string}&librarianEmail={string}&comments={string}&partnerId={id}&requestType={string}',
									parameters : [
											{
												name : 'subscriptionRequestId',
												type : 'Number',
												description : 'Unique identifier for the subscription request to update',
											},
											{
												name : 'requestDate',
												type : 'Date',
									...
									errors : [
											{
												...
												message : '{"error":"does not allow update without query parameters"}',
												explanation : 'The request had no query parameters.',
												resolution : 'Specify at least one filter query parameter in the request.'
											}, ],
