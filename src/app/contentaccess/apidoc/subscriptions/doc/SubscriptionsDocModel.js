				...
				[ function() {
					return {
						...
						calls : [ {
							...
							errors : [{code : '400', message : 'error: no termId', explanation : 'There is no termId query parameter.', resolution : 'Supply a valid termId parameter in the request'}, 
							          {code : '400', message : 'error: no quantity specified', explanation : 'There is no quantity query parameter.', resolution : 'Supply a valid quantity parameter in the request'}, 
							          {code : '400', message : 'error: unable to get term price', explanation : 'The term id does not identify a valid term.', resolution : 'Correct the term id value.'}, 
							          {code : '400', message : 'error: quantity must be between 1 and 99', explanation : 'The quantity is not between 1 and 99.', resolution : 'Correct the quantity to be between 1 and 99, inclusive.'}, ],
							...
							body_parameters : [],
							returns : 'an Array of Subscription objects',
							errors : [{code : '500', message : '<h1>Server Error (500)</h1>', explanation : 'The request did not include all three required parameters.', resolution : 'Supply partnerId, ipAddress, and userIdentifier query parameters in the request.'}, ],
							...
							parameters : [ {
								name : 'id',
								type : 'Number',
								description : 'Unique identifier for the party with a consortium for which to get active subscriptions',
							}, ],
							body_parameters : [],
							...
							header : 'Edit a Subscription By ID',
							summary : 'Edit the contents of a subscription specified by subscription ID.',
							op : 'PUT',
							uri : '/subscriptions/edit/?&subscriptionId={id}',
							parameters : [ {
								name : 'subscriptionId',
								type : 'Number',
