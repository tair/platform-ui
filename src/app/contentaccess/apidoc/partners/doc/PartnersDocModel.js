						...
						calls : [
									...
									errors : [
											{
												...
												explanation : 'The supplied URI does not match a registered partner pattern',
								...
								},
								{
									...
									errors : [
											{
												code : '400',
												message : '{"subscriptionDescriptionId":["This field is required."],"text":["This field is required."]}',
												explanation : 'The request did not pass a valid text for the item',
												resolution : 'Correct the POST request by adding a form-coded item text to the entity of the request.'
											}, ],
									...
									errors : [
											{
												...
												explanation : 'The DELETE operation must limit deletion to a subset of items.',
