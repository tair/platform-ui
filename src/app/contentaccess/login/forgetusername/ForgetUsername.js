...
angular.module(
	...
	function ($stateProvider) {
		$stateProvider.state('login.forgetusername.sendlink', {
			url: '',
			views: {
				'forgetusername': {
					controller: 'ForgetUsernameController',
					templateUrl: 'contentaccess/login/forgetusername/sendlink/sendlink.html'
				}
			}
			...
			views: {
				'forgetusername': {
					...
					templateUrl: 'contentaccess/login/forgetusername/thankyou/thankyou.html'
				}
			}
		});
	});
