			...
			$stateProvider.state('subscription.landing', {
				...
				views: {
					'subscription': {
						...
						templateUrl: 'contentaccess/subscription/commercial/commercial.html'
					}
				}
				...
				views: {
					'subscription': {
						...
						templateUrl: 'contentaccess/subscription/institution/institution.html'
					}
				}
				...
				views: {
					'subscription': {
						...
						templateUrl: 'contentaccess/subscription/individual/individual.html'
					}
				}
			});
		});
