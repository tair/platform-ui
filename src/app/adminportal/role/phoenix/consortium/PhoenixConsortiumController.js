    ...
    function (
        ...
        if (
          ...
          $http({
            ...
            .success(function (data, status, headers, config) {
              ...
              bootbox.alert(
                'New Consortium created: username=' +
                  data[1].username +
                  ' partyId=' +
                  data[0].partyId +
                  ' partyType=' +
          ...
          $http({
            ...
            .success(function (data, status, headers, config) {
              ...
              bootbox.alert(
                'New Consortium created: partyId=' +
                  data.partyId +
                  ' partyType=' +
                  data.partyType +
                  ' name=' +
      ...
      $scope.removeConfirm = function (consortium) {
        ...
        $http({
          url:
            $scope.apiUri +
            '/parties/consortiums/?credentialId=' +
            $scope.credentialId +
            '&secretKey=' +
            encodeURIComponent($scope.secretKey) +
            '&partyId=' +
