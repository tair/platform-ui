...
angular
  .module('platform-ui.adminportal.role.institution.consortium')
  .controller(
    /* Name */
      ...
      function (
        ...
        $scope.addConfirm = function () {
          ...
          $http({
            ...
            .error(function (data, status, headers, config) {
              alert(
                'Consortium cannot be found. Please create consortium before adding.'
              )
            })
        }
        ...
        $scope.removeConfirm = function (consortium) {
          $http({
            url:
              $scope.apiUri +
              '/parties/affiliations/?credentialId=' +
              $scope.credentialId +
              '&secretKey=' +
              encodeURIComponent($scope.secretKey) +
              '&parentPartyId=' +
        ...
        $http({
          url:
            $scope.apiUri +
            '/parties/?partyType=consortium&credentialId=' +
            $scope.credentialId +
            '&secretKey=' +
            encodeURIComponent($scope.secretKey),
          method: 'GET',
