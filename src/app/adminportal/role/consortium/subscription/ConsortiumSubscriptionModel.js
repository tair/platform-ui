...
angular.module('platform-ui.adminportal.role.consortium.subscription').factory(
  /* Name */
        ...
        partners: [
          {
            ...
            description:
              'BioCyc is a collection of 7667 Pathway/Genome Databases (PGDBs), plus software tools for understanding their data.',
          },
          {
            partnerId: 'phoenix',
            name: 'Phoenix',
            ...
            termOfServiceUri:
              'https://demotair.arabidopsis.org/doc/about/tair_terms_of_use/417',
            description: null,
          },
          {
            partnerId: 'tair',
            name: 'TAIR',
            logoUri:
              'https://s3-us-west-2.amazonaws.com/pw2-logo/tair_logo_highdef_originalcolors.png',
            homeUri: 'https://demotair.arabidopsis.org',
            termOfServiceUri:
              'https://demotair.arabidopsis.org/doc/about/tair_terms_of_use/417',
            description:
              'Genome database for the reference plant Arabidopsis thaliana',
          },
        ],
        activeSubscriptions: {
          tair: {
