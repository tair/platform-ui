...
angular
  ...
  .config(function ($stateProvider) {
    $stateProvider
      .state('role.consortium.subscription.list', {
        url: '/list',
        views: {
          subscription: {
            controller: 'ConsortiumSubscriptionListController',
            templateUrl:
              'adminportal/role/consortium/subscription/list/list.html',
          },
        },
      })
      .state('role.consortium.subscription.renewal', {
        ...
        views: {
          subscription: {
            ...
            templateUrl:
              'adminportal/role/consortium/subscription/renewal/renewal.html',
          },
        },
      })
      .state('role.consortium.subscription.request', {
        ...
        views: {
          subscription: {
            ...
            templateUrl:
              'adminportal/role/consortium/subscription/request/request.html',
          },
        },
      })
      .state('role.consortium.subscription.edit', {
        ...
        views: {
          subscription: {
            ...
            templateUrl:
              'adminportal/role/consortium/subscription/edit/edit.html',
          },
        },
      })
  })
