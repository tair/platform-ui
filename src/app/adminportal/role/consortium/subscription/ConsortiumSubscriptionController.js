...
angular
  .module('platform-ui.adminportal.role.consortium.subscription')
  .controller(
    /* Name */
      ...
      function (
        ...
        function init() {
          ...
          $scope.activeSubscriptions =
            ConsortiumSubscriptionModel.activeSubscriptions
          ...
          $http({
            url:
              $scope.apiUri + '/subscriptions/?partyId=' + $scope.consortiumId,
            method: 'GET',
          })
            .success(function (data, status, headers, config) {
              var dataObject = {}
