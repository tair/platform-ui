...
angular.module('platform-ui.librariantool.role.consortium.manage.institution').controller(
	/* Name */
	'ConsortiumManageInstitutionController',
	...
	function ($scope, $http, $cookies, $location, $state, Title, ConsortiumManageInstitutionModel) {
            $scope.setTitle(selectedInstitution.name);
            $scope.ipranges = ConsortiumManageInstitutionModel.ipranges;
            $scope.addGroupShow = "hidden";
            $scope.adding = false;
            $scope.newRange = ConsortiumManageInstitutionModel.newRange;
