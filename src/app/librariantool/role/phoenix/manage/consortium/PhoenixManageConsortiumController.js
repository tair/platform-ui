...
angular.module('platform-ui.librariantool.role.phoenix.manage.consortium').controller(
	/* Name */
	'PhoenixManageConsortiumController',
	  ...
	  //initializing orderBy function
	    ...
	    $scope.enterConsortium = function(consortium){
	    	if(!(consortium.state=='edit')){
	    		$state.go('role.phoenix.manage.institution', {'consortiumId':consortium.partyId});
	    	}
	    }
	    // init
            $http({
